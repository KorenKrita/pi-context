...
export function registerTravelTool(pi: ExtensionAPI, runtime: AcmSessionRuntime): void {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      "Use acm_travel when the fold gate holds: the boundary is named, NEXT is executable from the handoff, and omitted raw history remains recoverable through a direct pointer.",
