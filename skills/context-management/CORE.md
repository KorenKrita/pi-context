...
A context window is a **working set**: the exact material needed for the next action. Process accumulates; ACM keeps growth recoverable by naming a **boundary** before folding finished process into a **handoff** that leaves **NEXT** executable.
