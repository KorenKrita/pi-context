...
**Decision smells** prompt a pause when something feels off. **Recognizable moments** map a situation to the lightest reasonable transition. **Fold criteria** and **rebase criteria** must pass before travel earns its place. **Failure shapes** name what went wrong and the lightest correction when a fold or target choice was too aggressive or too late.
